/*
 * feeder_ws_test.sv: WS-mode variant of feeder_test.
 *
 * Uses sa_wavefront_feeder feeding ns_systolic_array, but forces
    ...
    initial begin
        ...
        wait (o_compDone) begin
            ...
            FINAL_RESULT_ASSERT : begin
                $display("WS results (2x2 feeder): c00=%0d c01=%0d c10=%0d c11=%0d",
        ...
        $display("\n");
        $display("***************************************************************************");
        $display("                          WS FEEDER TEST PASSED!                          ");
        $display("***************************************************************************");
        $display("\n");

        $finish;
    end
endmodule : feeder_ws_test
